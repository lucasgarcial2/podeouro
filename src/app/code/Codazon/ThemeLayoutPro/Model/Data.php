...
class Data extends \Magento\Framework\Model\AbstractModel
{
    ...
    protected $packageName = 'fastestpro-magento2';
    
    protected $packageTitle = 'Codazon - Fastestpro - Magento 2.x';
    
    protected $docUrl = 'http://codazon.com/document/fastestpro/magento2';
